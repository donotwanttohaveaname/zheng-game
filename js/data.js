...
DAYS[4] = [
  ...
  { t: 'if', cond: s => s.smell >= 3, then: [
    ...
    N("The vet's badge says ALEKSI. Zheng looks at it for slightly too long."),
    SAY('VET', "She's completely healthy."),
    N('He said it in a tone.'),
    Z('What tone?'),
    SAY('VET', 'No tone.'),
    { t: 'if', cond: s => s.sagaHeard >= 1, then: [
      N('Somewhere across the city, Joy is typing about an Aleksi. It is not this one. It is statistically unlikely to be this one.'),
      Z('...'),
      N('He does not mention it to her. Some coincidences are load-bearing and must not be disturbed.'),
    ] },
